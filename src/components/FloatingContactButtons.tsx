...
function formatWhatsApp(telefono: string): string {
    // Strip +, spaces, dashes, parentheses → e.g. "+52 55 7970 1379" → "5255XXXXXXXX"
    return telefono.replace(/[\+\s\-\(\)]/g, "");
}

function formatInstagram(instagram: string): string {
...
export default function FloatingContactButtons({
    ...
    const igHandle = formatInstagram(instagram);
