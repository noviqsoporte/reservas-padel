            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex gap-2 items-start text-[#94a3b8] text-sm">
                                <Instagram className="w-4 h-4 text-[#2563eb] mt-0.5 flex-shrink-0" />
                    ...
                    <div>
                        ...
                        <div className="mt-4">
                            ...
                            <a
                                href="#reservar"
                                className="inline-block border border-[#2563eb] text-[#2563eb] text-sm px-4 py-2 rounded-lg mt-2 hover:bg-[#2563eb] hover:text-white transition-colors"
                            >
                                Reservar ahora &rarr;
                            </a>
                        </div>
                ...
                <div className="py-6 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <p className="text-[#475569] text-sm flex items-center gap-1">
                        Hecho con ❤️ por <span className="text-[#2563eb] font-medium">Nexora</span>
                    </p>
                </div>
